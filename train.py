...
if __name__ == '__main__':
    ...
    model.train(
        ...
        # zooming out to make signs tiny
        
        # copy_paste creates more instances of small signs.
        copy_paste=0.3,  
        
        # forces signs to be learned even if 20% cut off.
        translate=0.15,   
        ...
        # Kept mild to respect retro-reflective properties
        hsv_h=0.015,
        hsv_s=0.5, 
        hsv_v=0.3, 
